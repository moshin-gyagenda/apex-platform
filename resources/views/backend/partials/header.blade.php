                        ...
                        <div class="max-h-72 overflow-y-auto">
                            <a href="#" class="flex px-4 py-3 hover:bg-gray-50 border-b border-gray-100 transition-colors">
                                ...
                                <div class="ml-3 w-full">
                                    <p class="text-sm font-medium text-gray-800">New Script</p>
                                    <p class="text-xs text-gray-500 truncate">New script submitted for marking</p>
                            ...
                            <a href="#" class="flex px-4 py-3 hover:bg-gray-50 border-b border-gray-100 transition-colors">
                                ...
                                <div class="ml-3 w-full">
                                    <p class="text-sm font-medium text-gray-800">Script Marked</p>
                                    <p class="text-xs text-gray-500 truncate">Script marking completed</p>
                            ...
                            <a href="#" class="flex px-4 py-3 hover:bg-gray-50 border-b border-gray-100 transition-colors">
                                ...
                                <div class="ml-3 w-full">
                                    <p class="text-sm font-medium text-gray-800">Script Traced</p>
                                    <p class="text-xs text-gray-500 truncate">Script location updated</p>
