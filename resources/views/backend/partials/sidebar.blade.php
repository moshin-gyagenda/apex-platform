...
<aside id="logo-sidebar"
    ...
    <div class="flex-1 h-full px-3 py-4 overflow-y-auto sidebar-scrollbar bg-white">
        ...
        <div class="space-y-1">
            ...
            <details class="group">
                <summary
                    class="sidebar-item border-l-3 {{ request()->routeIs('admin.categories.*') || request()->routeIs('admin.brands.*') || request()->routeIs('admin.product-models.*') || request()->routeIs('admin.settings.tax.*') || request()->routeIs('admin.security.*') ? 'border-primary-500 bg-primary-50' : 'border-transparent' }} flex items-center p-2 text-gray-600 rounded-lg cursor-pointer hover:bg-gray-100 hover:text-gray-700 group text-sm transition-all duration-200 pl-3">
                    <i data-lucide="settings" class="w-5 h-5 {{ request()->routeIs('admin.categories.*') || request()->routeIs('admin.brands.*') || request()->routeIs('admin.product-models.*') || request()->routeIs('admin.settings.tax.*') || request()->routeIs('admin.security.*') ? 'text-primary-500' : 'text-gray-500' }} group-hover:text-primary-500 transition-colors"></i>
                    ...
                    <ul class="pl-6 mt-2 space-y-1">
                        ...
                        <li>
                            <a href="{{ route('admin.security.index') }}"
                                class="sidebar-item flex items-center p-2 text-gray-600 rounded-lg hover:bg-gray-100 hover:text-gray-700 text-sm transition-all duration-150 {{ request()->routeIs('admin.security.*') ? 'bg-primary-50 text-primary-600' : '' }}">
                                <i data-lucide="shield-alert" class="w-4 h-4 mr-2 {{ request()->routeIs('admin.security.*') ? 'text-primary-500' : 'text-gray-400' }} group-hover:text-primary-500 transition-colors"></i>
                                <span class="text-sm font-medium">Security Monitoring</span>
                            </a>
                        </li>
                    </ul>
                </div>
