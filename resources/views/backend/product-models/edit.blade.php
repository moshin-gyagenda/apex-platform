    ...
    <div class="p-4 sm:ml-64 mt-16 flex flex-col min-h-screen">
        ...
        <nav class="flex mb-5" aria-label="Breadcrumb">
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <li aria-current="page">
                    <div class="flex items-center">
                        <i data-lucide="chevron-right" class="w-4 h-4 text-gray-400 mx-2"></i>
                        <span class="text-sm font-medium text-gray-500">Edit Product Model</span>
                    </div>
                </li>
            </ol>
        </nav>
        ...
        <div class="container mx-auto py-6 px-4 sm:px-6">
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
                <h1 class="text-xl font-semibold text-gray-800">Edit Product Model</h1>
            ...
            <form action="{{ route('admin.product-models.update', $productModel->id) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="bg-white rounded-lg border border-gray-200 overflow-hidden">
                    <div class="px-4 py-4 border-b border-gray-200 bg-gray-50">
                        <h3 class="text-lg font-semibold text-gray-800">Product Model Information</h3>
                        <p class="mt-1 text-sm text-gray-500">Update the product model's information</p>
                    </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    >
                                        ...
                                        @foreach($brands as $brand)
                                            <option value="{{ $brand->id }}" {{ old('brand_id', $productModel->brand_id) == $brand->id ? 'selected' : '' }}>
                                                {{ $brand->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        name="model_number"
                                        id="model_number"
                                        value="{{ old('model_number', $productModel->model_number) }}"
                        ...
                        <div>
                            ...
                            <div id="specifications-container" class="space-y-3">
                                @if(old('spec_key'))
                                    ...
                                    @endforeach
                                @elseif($productModel->specifications && count($productModel->specifications) > 0)
