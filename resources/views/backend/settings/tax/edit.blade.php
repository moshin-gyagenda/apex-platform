    ...
    <div class="p-4 sm:ml-64 mt-16 flex flex-col min-h-screen">
        ...
        <nav class="flex mb-5" aria-label="Breadcrumb">
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <li aria-current="page">
                    <div class="flex items-center">
                        <i data-lucide="chevron-right" class="w-4 h-4 text-gray-400 mx-2"></i>
                        <span class="text-sm font-medium text-gray-500">Tax Settings</span>
                    </div>
                </li>
            </ol>
        </nav>
        ...
        <div class="container mx-auto py-6 px-4 sm:px-6">
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
                <h1 class="text-xl font-semibold text-gray-800">Tax Settings</h1>
            ...
            <form action="{{ route('admin.settings.tax.update') }}" method="POST">
                ...
                <div class="bg-white rounded-lg border border-gray-200 overflow-hidden">
                    <div class="px-4 py-4 border-b border-gray-200 bg-gray-50">
                        <h3 class="text-lg font-semibold text-gray-800">Tax Configuration</h3>
                        <p class="mt-1 text-sm text-gray-500">Set the tax percentage that will be applied to all sales in the POS system</p>
                    </div>
                    <div class="px-4 py-5 sm:p-6 space-y-6">
                        <!-- Tax Percentage -->
                        <div>
                            <h4 class="text-sm font-semibold text-gray-700 mb-4 flex items-center">
                                <i data-lucide="percent" class="w-4 h-4 mr-2 text-primary-500"></i>
                                Tax Settings
                            </h4>
                            <div>
                                ...
                                <div class="relative">
                                    <input
                                        ...
                                        step="0.01"
                                        required
                                        class="w-full py-2 px-3 border border-gray-300 rounded-lg focus:outline-none focus:border-primary-500 transition pl-10"
                                    >
                                    <span class="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-500 text-sm">%</span>
                                </div>
                                <p class="mt-1 text-xs text-gray-500">Enter the tax percentage (0-100). This will be applied to all sales in the Point of Sale system.</p>
                        ...
                        <div class="bg-gray-50 rounded-lg p-4 border border-gray-200">
                            <div class="flex items-center gap-2 mb-2">
                                ...
                                <h5 class="text-sm font-semibold text-gray-700">Current Tax Rate</h5>
                            </div>
                            <p class="text-sm text-gray-600">
                                The current tax rate is set to <strong class="text-primary-600">{{ number_format($taxPercentage, 2) }}%</strong>.
                                This will be applied to all sales in the POS system after you save these settings.
                            </p>
                        </div>
                    </div>

                    <div class="px-4 py-4 bg-gray-50 border-t border-gray-200 flex justify-end gap-3">
                        ...
                        <button type="submit" class="inline-flex items-center px-4 py-2 bg-primary-500 text-white rounded-lg text-sm font-medium hover:bg-primary-600 transition-colors">
