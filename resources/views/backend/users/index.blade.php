        ...
        <div class="container mx-auto py-6 px-4 sm:px-6">
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
                ...
                <div class="flex flex-wrap gap-2">
                    ...
                    <a href="{{ route('admin.users.export.excel', request()->query()) }}" class="inline-flex items-center px-4 py-2 bg-green-500 border border-transparent rounded-lg text-sm font-medium text-white hover:bg-green-600 transition-colors">
                        <i data-lucide="file-spreadsheet" class="w-4 h-4 mr-2"></i>
                        Export Excel
                    </a>
                    <a href="{{ route('admin.users.export.pdf', request()->query()) }}" class="inline-flex items-center px-4 py-2 bg-red-500 border border-transparent rounded-lg text-sm font-medium text-white hover:bg-red-600 transition-colors">
                        <i data-lucide="file-text" class="w-4 h-4 mr-2"></i>
                        Export PDF
                    </a>
                    <a href="{{ route('admin.users.create') }}" class="inline-flex items-center px-4 py-2 bg-primary-500 border border-transparent rounded-lg text-sm font-medium text-white hover:bg-primary-600 transition-colors">
                ...
                <div class="bg-white rounded-lg border border-gray-200 p-4">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-2xl font-semibold text-gray-800 mt-1">{{ $stats['verified'] }}</p>
                        </div>
                ...
                <div class="bg-white rounded-lg border border-gray-200 p-4">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-2xl font-semibold text-gray-800 mt-1">{{ $stats['unverified'] }}</p>
                        </div>
                ...
                <div class="bg-white rounded-lg border border-gray-200 p-4">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-2xl font-semibold text-gray-800 mt-1">{{ $stats['with_roles'] }}</p>
                        </div>
                ...
                <div id="users-content">
                    @if($users->isEmpty())
                        <div class="flex flex-col items-center justify-center py-12">
                            ...
                            <a href="{{ route('admin.users.create') }}" class="mt-4 inline-flex items-center px-4 py-2 bg-primary-500 text-white rounded-lg hover:bg-primary-600 transition-colors font-medium">
                                <i data-lucide="user-plus" class="w-4 h-4 mr-2"></i>
                                Add Your First User
                            </a>
                        </div>
                            ...
                            <table class="w-full">
                                <thead>
                                    <tr class="border-b border-gray-200 bg-gray-50">
                                        ...
                                        <th class="py-3 px-4 text-left text-sm font-semibold text-gray-700 hidden lg:table-cell">Email</th>
                                        <th class="py-3 px-4 text-left text-sm font-semibold text-gray-700 hidden md:table-cell">Role</th>
                                        <th class="py-3 px-4 text-left text-sm font-semibold text-gray-700 hidden lg:table-cell">Status</th>
                                        ...
                                        <tr class="border-b border-gray-100 hover:bg-gray-50 transition-colors {{ $index % 2 === 0 ? 'bg-white' : 'bg-gray-50/30' }}">
                                            ...
                                            <td class="py-3 px-4 text-center">
                                                <div class="flex items-center justify-center space-x-2">
                                                    <a href="{{ route('admin.users.edit', $user->id) }}" class="text-primary-500 hover:text-primary-600 transition-colors" title="Edit">
                                                        <i data-lucide="edit" class="w-4 h-4"></i>
                                                    </a>
                                                    <a href="{{ route('admin.users.show', $user->id) }}" class="text-primary-500 hover:text-primary-600 transition-colors" title="View">
            ...
            <div class="flex items-start gap-4">
                ...
                <div class="flex-1">
                    ...
                    <p class="mt-2 text-sm text-gray-600">
                        Are you sure you want to delete <span id="user-name-display" class="font-medium text-gray-800"></span>? This action cannot be undone.
                    </p>
